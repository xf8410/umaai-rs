...
## 2026-08-25
- **体力门限逻辑修正**：y3 门禁（吃面前软目标 25 / 训练后硬底线 15 / 缺口软成本 0.5）改为**每年吃面决策都评估**（原仅第三年）；吃面回合放掉硬门限（`vital_rest_eating=0`）**仅第三年**（fail_rate_drop=100% 必成），第一/二年吃面训练仍可能失败（30%/50%），保留 30 门限。失败率 1.5%
