...
'''
new='''# Remove the race shortcut in run_ramen_select.  Match by function body rather than the prose
# comment: rustfmt/documentation edits may change comments without changing the code to patch.
