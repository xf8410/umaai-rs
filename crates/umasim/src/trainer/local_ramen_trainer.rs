...
pub fn parse_override_toml(s: &str) -> Result<ParamOverride, String> {
    ...
    for raw in s.lines() {
        ...
        scalar! {
            "vital_rest" => vital_rest : i32,
            "wisdom_vital_floor" => wisdom_vital_floor : i32,
            "motivation_outing" => motivation_outing : i32,
            "status_rate" => status_rate : f32,
            "pt_tradeoff" => pt_tradeoff : f32,
            "pt_tradeoff_shining" => pt_tradeoff_shining : f32,
            "pt_tradeoff_super" => pt_tradeoff_super : f32,
            "cap_discount_weight" => cap_discount_weight : f32,
            "failure_penalty" => failure_penalty : f32,
            "effective_ramen_failure" => effective_ramen_failure : bool,
            "shining_bonus" => shining_bonus : f32,
            "train_vital_value" => train_vital_value : f32,
            "rest_base" => rest_base : f32,
            "rest_vital_value" => rest_vital_value : f32,
            "rest_target_vital" => rest_target_vital : i32,
            "race_panel_discount" => race_panel_discount : f32,
            "race_free_urgency_weight" => race_free_urgency_weight : f32,
            "race_gate_slack" => race_gate_slack : u32,
            "outing_base" => outing_base : f32,
            "friend_outing_bonus" => friend_outing_bonus : f32,
            "ramen_pt_weight" => ramen_pt_weight : f32,
            "ramen_effect_weight" => ramen_effect_weight : f32,
            "ramen_special_cost" => ramen_special_cost : f32,
            "ramen_stock_cost" => ramen_stock_cost : f32,
            "region_xunlian_weight" => region_xunlian_weight : f32,
            "region_hint_weight" => region_hint_weight : f32,
            "region_youqing_weight" => region_youqing_weight : f32,
            "region_weak_cover_weight" => region_weak_cover_weight : f32,
            "event_vital_weight" => event_vital_weight : f32,
            "event_motivation_weight" => event_motivation_weight : f32,
            "event_bad_flag_penalty" => event_bad_flag_penalty : f32,
            "early_bond_value" => early_bond_value : f32,
            "hint_bonus" => hint_bonus : f32,
            "first_friend_click_value" => first_friend_click_value : f32,
            "low_friend_bond_value" => low_friend_bond_value : f32,
            "active_friend_value" => active_friend_value : f32,
            "feeling_overflow_threshold" => feeling_overflow_threshold : i32,
            "overflow_value" => overflow_value : f32,
            "max_base_score_sacrifice" => max_base_score_sacrifice : f32,
            "status_reserve_max" => status_reserve_max : f32,
            "dynamic_status_balance" => dynamic_status_balance : bool,
            "status_gap_strength" => status_gap_strength : f32,
            "status_overflow_strength" => status_overflow_strength : f32,
            "dynamic_vital" => dynamic_vital : bool,
            "probabilistic_hint" => probabilistic_hint : bool,
            "expected_fail" => expected_fail : bool,
            "checkpoint_scale" => checkpoint_scale : f32,
            "rmj_cross_bonus" => rmj_cross_bonus : f32,
            "great_cross_bonus" => great_cross_bonus : f32,
            "ramen_window_weight" => ramen_window_weight : f32,
            "ramen_train_coupling_weight" => ramen_train_coupling_weight : f32,
            "ramen_weak_train_boost" => ramen_weak_train_boost : f32,
            "friend_hidden_starve_weight" => friend_hidden_starve_weight : f32,
            "friend_future_hidden_weight" => friend_future_hidden_weight : f32,
            "friend_proactive_weight" => friend_proactive_weight : f32,
            "eat_guarantee_weight" => eat_guarantee_weight : f32,
            "cook2_stock_weight" => cook2_stock_weight : f32,
            "eat_requires_training" => eat_requires_training : bool,
            "eat_requires_covered_train" => eat_requires_covered_train : bool,
            "y3_pre_train_vital_target" => y3_pre_train_vital_target : i32,
            "y3_post_train_vital_target" => y3_post_train_vital_target : i32,
            "y3_vital_shortfall_weight" => y3_vital_shortfall_weight : f32,
            "y3_post_train_hard_floor" => y3_post_train_hard_floor : i32,
            "y3_recovery_horizon" => y3_recovery_horizon : bool,
            "friend_outing_replaces_rest" => friend_outing_replaces_rest : bool,
            "friend_outing3_recovery_vital" => friend_outing3_recovery_vital : i32,
            "dynamic_special_targets" => dynamic_special_targets : bool,
        }
    }
    if n_set == 0 {
