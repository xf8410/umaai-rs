...
pub const GENE_SPECS: &[GeneSpec] = &[
    ...
    f_gene!("pt_tradeoff_super", GeneLayer::Policy, 0.0, 64.0, 35.0),
    ...
    f_gene!("region_youqing_weight", GeneLayer::Policy, 0.0, 10.0, 0.4),
    f_gene!("region_weak_cover_weight", GeneLayer::Policy, 0.0, 60.0, 35.0),
    ...
    f_gene!("hint_bonus", GeneLayer::Local, 0.0, 15.0, 8.0),
    ...
    f_gene!("max_base_score_sacrifice", GeneLayer::Local, 40.0, 400.0, 200.0),
    ...
    f_gene!("checkpoint_scale", GeneLayer::Local, 0.0, 1.5, 0.15),
    f_gene!("rmj_cross_bonus", GeneLayer::Local, 0.0, 300.0, 0.0),
    f_gene!("great_cross_bonus", GeneLayer::Local, 0.0, 300.0, 0.0),
    f_gene!("ramen_window_weight", GeneLayer::Local, 0.0, 0.5, 0.15),
